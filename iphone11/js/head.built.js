require = function () {
    ...
    17: [function (t, e, r) {
        ...
        "@marcom/function-utils/memoize": 20
    }],
    18: [function (t, e, r) {
        "use strict";
        e.exports = {
    ...
    39: [function (t, e, r) {
        ...
        function n() {
            return s.os.ios && 12 === s.os.version.major
        }
        ...
        var c = t("@marcom/ac-headjs"),
            s = t("@marcom/useragent-detect"),
            u = t("@marcom/feature-detect/prefersReducedMotion")(),
            l = (t("@marcom/feature-detect/cssPropertyAvailable"), document.documentElement.classList.contains("aow"));
        c.addTests({
            "reduced-motion": u,
            edge: s.browser.edge,
            ie: s.browser.ie,
            android: s.os.android,
            quicklook: o(),
            "modern-quicklook": i(),
            "classic-quicklook": a(),
            "inline-video": !l,
            "hero-enhanced": !u && !document.documentElement.classList.contains("aow") && !s.browser.ie,
            "hero-screen-fix": s.browser.safari,
            "video-edit-intro": !u && !document.documentElement.classList.contains("aow") && !s.browser.ie
        }), c.htmlClass()
    }, {
        "@marcom/ac-headjs": 7,
        "@marcom/feature-detect/cssPropertyAvailable": 17,
        "@marcom/feature-detect/prefersReducedMotion": 19,
        "@marcom/useragent-detect": 24
    }],
